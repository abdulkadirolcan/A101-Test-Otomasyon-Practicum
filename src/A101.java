...
public class A101{
    ...
    System.setProperty("webdriver.chrome.driver","C:\\Users\\abdul\\OneDrive\\Masaüstü\\chromedriver.exe");
        ...
        Thread.sleep(5000);
        String barcode="test@test.com";

        WebElement strLocator = driver.findElement(By.xpath("(//input[@name='user_email'])[1]"));
        ...
        String line="Beeerkay sok No:12/11";
        ...
        System.out.println("Clicked Check Box.. finished");
    }
